  ...
  map_df(function(fname) {
    ...
    read_csv(here(DEMO_DATA_DIR, fname),
      ...
      mutate(education = as.character(education),
             ...
             test_order = as.character(test_order),
             residence_city = as.character(residence_city),
             anything_else = as.character(anything_else),
             trial_error_notes = as.character(trial_error_notes)) |>
...
adult_demo <- adult_demo |>
  ...
  # mutate(session_error_notes = coalesce(session_error_notes, 
  #                                 session_error_notes...11,
  #                                 session_error_notes...13),
  #        second_session = coalesce(second_session, 
  #                                  second_session...12,
  #                                  second_session...14)) |>
  #select(-contains("..."))
```
...
columns_to_character <- c("gestation_week", "lang2_exposure","lang3_exposure",
                          ...
                          "sibling3_age","hours_daycare",
                          "hours_parentA","hours_parentB","hours_siblings",
                          "hours_adults", "sibling1_age", "sibling2_age", 
                          "parentB_education","sibling1_gender","sibling2_gender", "sibling4_age", "sibling5_age", 
                          "lang2","lang3","lang4","lang4_exposure", "parentA_education",
                          "test2_error_info", "participant_id", "nationality",
                         "hours_other","age_days","test_order","session_error_info",
                         "lang1_exposure","fam4_error_info","test1_error_info","parentB_native_lang1","hearing_info")
...
toddler_demo <- toddler_demo #|>
  #select(-c(80:96)) # get rid of junk columns that the validator missed
```
