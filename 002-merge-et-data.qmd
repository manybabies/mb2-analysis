...
data_normalized <- data_rezeroed %>%
  mutate(point_of_disambiguation=0) %>% # data is already joined correctly, but function currently fails
  normalize_times()
...
- point of disambiguation is currently not used to normalize trials (this probably needs to happen)
