...
d <- summarize_participant_test_first_trial %>% group_by(condition) %>% count(sum_distractor_exit)
t <- summarize_participant_test_first_trial %>% group_by(condition) %>% count(sum_target_exit)
