...
saveRDS(summarize_fam_aoi_overall, file=here(results_path,"summary_fam_aoi_overall.rds"))
```
...
saveRDS(fam_m_comparision_PTL_toddlers, file=here(results_path,"fam_m_comparision_PTL_toddlers.rds"))
```
...
fam_m_comparison_PTL_adults <-  brms::bayes_factor(bm_fam_aoi_adults, null_fam_aoi_adults)
 ...
 saveRDS(fam_m_comparison_PTL_adults, file=here(results_path,"fam_m_comparison_PTL_adults.rds"))
```
...
saveRDS(summarize_overall_familiarization_first_look, file=here(results_path,"summary_fam_fl_overall.rds"))
```
...
saveRDS(fam_m_comparison_FL_toddlers, file=here(results_path,"fam_m_comparison_FL_toddlers.rds"))
```
...
#this seems broken at the moment
 ...
 fam_m_comparison_FL_adults <-  brms::bayes_factor(bm_fam_first_look_adults, null_fam_first_look_adults)
  ...
  saveRDS(fam_m_comparison_FL_adults, file=here(results_path,"fam_m_comparison_FL_adults.rds"))
```
