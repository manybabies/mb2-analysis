...
bm_aoi_toddlers_knowledge <- brm(
  prop_exit_adj ~ 1 + condition_k * age_mo_c + 
    (1 + condition_k * age_mo_c | lab_id),
  family = gaussian,
  prior = priors,
  save_pars = save_pars(all = TRUE),
  filter(summarize_participant_test_first_trial, age_cohort == "toddlers"), 
...
bm_aoi_toddlers_ignorance <- brm(
  prop_exit_adj ~ 1 + condition_i * age_mo_c + 
    (1 + condition_i * age_mo_c | lab_id),
  family = gaussian,
  prior = priors,
  save_pars = save_pars(all = TRUE),
  filter(summarize_participant_test_first_trial, age_cohort == "toddlers"), 
...
bm_test_first_look_toddlers_knowledge <- brm(
  correct_first_look ~ 1 + condition_k * age_mo_c +
    (1 + condition_k * age_mo_c | lab_id),
  family = bernoulli(link = "logit"),
  prior = priors,
  save_pars = save_pars(all = TRUE),
...
bm_test_first_look_toddlers_ignorance <- brm(
  correct_first_look ~ 1 + condition_i * age_mo_c +
    (1 + condition_i * age_mo_c | lab_id),
  family = bernoulli(link = "logit"),
  prior = priors,
  save_pars = save_pars(all = TRUE),
