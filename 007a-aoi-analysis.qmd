...
bm_fam_first_look_adults_less_inf_prior <- brm(first_look ~ 1+familiarization_trial_num_4+(1+familiarization_trial_num_4|lab_id)+(1+familiarization_trial_num_4|participant_lab_id),
        ...
        sample_prior=TRUE,
        control = list(adapt_delta=0.99,stepsize=.1, max_treedepth=12))
summary(bm_fam_first_look_adults2)
prior_summary(bm_fam_first_look_adults2)
...
saveRDS(bm_test_first_look_toddlers_less_inf_prior, file = here(RESULTS_FOLDER,"bm_test_first_look_toddlers_less_inf_prior.rds"))
```
...
saveRDS(bm_test_first_look_adults_less_inf_prior, file = here(RESULTS_FOLDER,"bm_test_first_look_adults_less_inf_prior.rds"))
```
