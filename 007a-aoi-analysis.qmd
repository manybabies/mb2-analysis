...
#cache
saveRDS(bm_fam_aoi_adults_trial_number_effect, file=here(RESULTS_FOLDER,"bm_fam_aoi_adults_intercept_effect.rds"))
```
...
#get_variables(bm_aoi_toddlers)
#get main coefficient estimate and HDI
bm_test_first_look_toddlers_intercept_effect <- bm_test_first_look_toddlers %>%
  spread_draws(b_condition_c) %>%
  mean_hdi(.width = 0.95)

#cache
saveRDS(bm_test_first_look_toddlers_intercept_effect, file=here(RESULTS_FOLDER,"bm_test_first_look_toddlers_intercept_effect.rds"))
```
