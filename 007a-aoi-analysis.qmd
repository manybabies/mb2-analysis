...
test_m_comparison_PTL_toddlers <- brms::bayes_factor(bm_aoi_toddlers, null_aoi_toddlers)
...
```{r}
null_aoi_toddlers_interaction <-  update(bm_aoi_toddlers, formula = ~ .-condition_c*age_mo_c)
summary(null_aoi_toddlers_interaction)
test_m_comparison_PTL_toddlers_interaction <- brms::bayes_factor(bm_aoi_toddlers, null_aoi_toddlers_interaction)
...
test_m_comparison_PTL_adults <- brms::bayes_factor(bm_aoi_adults, null_aoi_adults)
...
bm_fam_first_look_toddlers2 <- brm(first_look ~ 1+familiarization_trial_num_4+(1+familiarization_trial_num_4|lab_id)+(1+familiarization_trial_num_4|participant_lab_id),
         family=bernoulli(link = "logit"),
         prior = priors2,
         save_pars = save_pars(all = TRUE),
        filter(d_anticipatory_fam,age_cohort=="toddlers"),
        ...
        sample_prior=TRUE,
        control = list(adapt_delta=0.99,stepsize=.1, max_treedepth=12))
summary(bm_fam_first_look_toddlers2)
prior_summary(bm_fam_first_look_toddlers2)

saveRDS(bm_fam_first_look_toddlers2, file = here(RESULTS_FOLDER,"bm_fam_first_look_toddlers2.rds"))
```
...
```{r}
#this seems broken at the moment
null_fam_first_look_toddlers2 <-  update(bm_fam_first_look_toddlers2, formula = ~ .-1) # remove intercept
summary(null_fam_first_look_toddlers2)
fam_m_comparison_FL_toddlers2 <- brms::bayes_factor(bm_fam_first_look_toddlers2, null_fam_first_look_toddlers2)

saveRDS(fam_m_comparison_FL_toddlers2, file=here(RESULTS_FOLDER,  "fam_m_comparison_FL_toddlers2.rds"))
```
#### Adults
...
bm_fam_first_look_adults2 <- brm(first_look ~ 1+familiarization_trial_num_4+(1+familiarization_trial_num_4|lab_id)+(1+familiarization_trial_num_4|participant_lab_id),
         family=bernoulli(link = "logit"),
         prior = priors2,
         save_pars = save_pars(all = TRUE),
        filter(d_anticipatory_fam,age_cohort=="adults"),
...
saveRDS(bm_fam_first_look_adults2, file = here(RESULTS_FOLDER,"bm_fam_first_look_adults2.rds"))
```
...
```{r}
null_fam_first_look_adults2 <-  update(bm_fam_first_look_adults2, formula = ~ .-1) #remove intercept
summary(null_fam_first_look_adults2)
fam_m_comparison_FL_adults2 <-  brms::bayes_factor(bm_fam_first_look_adults2, null_fam_first_look_adults2)
 
saveRDS(fam_m_comparison_FL_adults2, file=here(RESULTS_FOLDER, "fam_m_comparison_FL_adults2.rds"))
```
### Test Data
...
test_m_comparison_FL_toddlers <- brms::bayes_factor(bm_test_first_look_toddlers, null_first_look_toddlers)
...
bm_test_first_look_toddlers2 <- brm(
  correct_first_look ~ 1+condition_c+age_mo_c+condition_c*age_mo_c+(1+condition_c+age_mo_c+condition_c*age_mo_c|lab_id),
  family=bernoulli(link = "logit"),
  prior = priors2,
  save_pars = save_pars(all = TRUE),
  ...
  sample_prior=TRUE,
  control = list(adapt_delta=0.99,stepsize=.1, max_treedepth=12))
summary(bm_test_first_look_toddlers2)
prior_summary(bm_test_first_look_toddlers2)

saveRDS(bm_test_first_look_toddlers2, file = here(RESULTS_FOLDER,"bm_test_first_look_toddlers2.rds"))
```
...
```{r}
null_first_look_toddlers2 <-  update(bm_test_first_look_toddlers2, formula = ~ .-condition_c)
summary(null_first_look_toddlers2)
test_m_comparison_FL_toddlers2 <- brms::bayes_factor(bm_test_first_look_toddlers2, null_first_look_toddlers2)

saveRDS(test_m_comparison_FL_toddlers2, file=here(RESULTS_FOLDER, "test_m_comparison_FL_toddlers2.rds"))
```
...
test_m_comparison_FL_adults <- brms::bayes_factor(bm_test_first_look_adults, null_first_look_adults)
...
```{r}
bm_test_first_look_adults2 <- brm(
  correct_first_look ~ 1+condition_c+(1+condition_c|lab_id),
  family=bernoulli(link = "logit"),
  prior = priors2,
  save_pars = save_pars(all = TRUE),
  ...
  sample_prior=TRUE,
  control = list(adapt_delta=0.99,stepsize=.1, max_treedepth=12))
summary(bm_test_first_look_adults2)
prior_summary(bm_test_first_look_adults2)

saveRDS(bm_test_first_look_adults2, file = here(RESULTS_FOLDER,"bm_test_first_look_adults2.rds"))
```
...
```{r}
null_first_look_adults2 <-  update(bm_test_first_look_adults2, formula = ~ .-condition_c)
summary(null_first_look_adults2)
test_m_comparison_FL_adults2 <- brms::bayes_factor(bm_test_first_look_adults2, null_first_look_adults2)

saveRDS(test_m_comparison_FL_adults2, file = here(RESULTS_FOLDER,  "test_m_comparison_FL_adults2.rds"))
```
...
## Main model with a less informative prior
