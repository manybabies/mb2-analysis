...
test_comparison_aoi_toddlers_both <- brms::bayes_factor(bm_aoi_toddlers_both, null_aoi_toddlers_both)
...
test_comparison_aoi_adults_both <- brms::bayes_factor(bm_aoi_adults_both, null_aoi_adults_both)
...
test_comparison_aoi_toddlers_both_order <- brms::bayes_factor(bm_aoi_toddlers_both_order, null_aoi_toddlers_both_order)
...
```{r}
h_aoi_adults_both_order <- hypothesis(bm_aoi_adults_both_order, "condition_c:test_trial_num = 0")
...
test_comparison_aoi_adults_both_order <- brms::bayes_factor(bm_aoi_adults_both_order, null_aoi_adults_both_order)
...
test_m_comparison_aoi_toddlers_correct_final_fam_trial <-  brms::bayes_factor(bm_aoi_toddlers_correct_final_fam_trial, null_aoi_toddlers_correct_final_fam_trial)
...
test_m_comparison_aoi_adults_correct_final_fam_trial <- brms::bayes_factor(bm_aoi_adults_correct_final_fam_trial, null_aoi_adults_correct_final_fam_trial)
...
test_m_comparison_aoi_adults_sufficient_fam_prop_looking <- brms::bayes_factor(bm_aoi_adults_sufficient_fam_prop_looking, null_aoi_adults_sufficient_fam_prop_looking)
...
```{r}
h_aoi_toddlers_method <- hypothesis(bm_aoi_toddlers_method, "condition_c:method_c = 0", class="b")
...
```{r}
null_aoi_toddlers_method <-  update(bm_aoi_toddlers_method, formula = ~ .-condition_c:method_c)
summary(null_aoi_toddlers_method)
test_m_comparison_aoi_toddlers_method <- brms::bayes_factor(bm_aoi_toddlers_method, null_aoi_toddlers_method)
...
```{r}
h_aoi_adults_method <- hypothesis(bm_aoi_adults_method, "condition_c:method_c = 0")
h_aoi_adults_method 
...
```{r}
null_aoi_adults_method <-  update(bm_aoi_adults_method, formula = ~ .-condition_c:method_c)
summary(null_aoi_adults_method)
test_m_comparison_aoi_adults_method <- brms::bayes_factor(bm_aoi_adults_method, null_aoi_adults_method)
...
overall_shifts_location_change <- ggplot(d_location_change,aes(age_cohort,num_shifts, color=age_cohort))+
 ...
 overall_shifts_location_change <- ggplot(d_location_change,aes(age_cohort,num_shifts, color=age_cohort))+
  ...
  geom_half_boxplot(data=filter(d_location_change,age_cohort=="toddlers"),side="r",nudge=0.15,width=0.4,errorbar.draw=F, outlier.alpha = 0)+
  geom_half_boxplot(data=filter(d_location_change,age_cohort=="adults"),side="l",nudge=0.15,width=0.4,errorbar.draw=F, outlier.alpha = 0)+
...
bm_test_shifts_age_cohort <- brm(num_shifts ~ 1+condition_c+age_cohort_c+condition_c*age_cohort_c+(1+condition_c+age_cohort_c+condition_c*age_cohort_c|lab_id),
         family=gaussian,
         prior = priors,
         save_pars = save_pars(all = TRUE),
...
bm_test_shifts_age_cohort %>%
  spread_draws(b_condition_c:age_cohort_c, sigma) %>%
  mean_hdi(.width = 0.95)
```
...
```{r}
h_test_shifts_age_cohort <- hypothesis(bm_test_shifts_age_cohort, "condition_c:age_cohort_c = 0")
...
```{r}
null_test_shifts_age_cohort <-  update(bm_test_shifts_age_cohort, formula = ~ .-condition_c:age_cohort_c)
...
saveRDS(bm_test_toddlers_shifts_al, file = here(RESULTS_FOLDER,"bm_test_toddlers_shifts_al.rds"))
```

```{r}
#get main coefficient estimate and HDI
bm_test_toddlers_shifts_al %>%
  spread_draws(b_condition_c, sigma) %>%
  mean_hdi(.width = 0.95)
...
```{r}
h_test_shifts_al <- hypothesis(bm_test_toddlers_shifts_al, "condition_c:num_shifts = 0")
h_test_shifts_al 
...
```{r}
null_test_toddlers_shifts_al <-  update(bm_test_toddlers_shifts_al, formula = ~ .-condition_c:num_shifts)
summary(null_test_toddlers_shifts_al)
test_m_comparison_toddlers_shifts_al <- brms::bayes_factor(bm_test_toddlers_shifts_al, null_test_toddlers_shifts_al)
...
saveRDS(bm_test_adults_shifts_al, file = here(RESULTS_FOLDER,"bm_test_adults_shifts_al.rds"))
```

```{r}
#get main coefficient estimate and HDI
bm_test_adults_shifts_al %>%
  spread_draws(b_condition_c, sigma) %>%
  mean_hdi(.width = 0.95)
...
```{r}
h_test_adults_shifts_al <- hypothesis(bm_test_adults_shifts_al, "condition_c:num_shifts = 0")
h_test_adults_shifts_al 
plot(h_test_shifts_al)
# evidence in favor of num_shifts being different from zero?
1/h_test_adults_shifts_al$hypothesis$Evid.Ratio
```

Alternate Bayes factor approach

```{r}
null_test_adults_shifts_al <-  update(bm_test_adults_shifts_al, formula = ~ .-condition_c:num_shifts)
summary(null_test_adults_shifts_al)
test_m_comparison_adults_shifts_al <- brms::bayes_factor(bm_test_adults_shifts_al, null_test_adults_shifts_al)
...
saveRDS(bm_test_toddlers_diff_mouse_bear_al, file = here(RESULTS_FOLDER,"bm_test_toddlers_diff_mouse_bear_al.rds"))
```
...
```{r}
null_test_toddlers_diff_mouse_bear_al <-  update(bm_test_toddlers_diff_mouse_bear_al, formula = ~ .-diff_mouse_bear)
summary(null_test_toddlers_diff_mouse_bear_al)
test_m_comparison_toddlers_diff_mouse_bear_al <- brms::bayes_factor(bm_test_toddlers_diff_mouse_bear_al, null_test_toddlers_diff_mouse_bear_al)
...
saveRDS(bm_test_toddlers_adults_diff_mouse_bear_al, file = here(RESULTS_FOLDER,"bm_test_adults_diff_mouse_bear_al.rds"))
```

```{r}
#get main coefficient estimate and HDI
bm_test_adults_diff_mouse_bear_al %>%
  spread_draws(b_condition_c, sigma) %>%
  mean_hdi(.width = 0.95)
...
```{r}
h_test_adults_diff_mouse_bear_al <- hypothesis(bm_test_adults_diff_mouse_bear_al, "condition_c:diff_mouse_bear = 0")
h_test_adults_diff_mouse_bear_al 
plot(h_test_adults_diff_mouse_bear_al)
# evidence in favor of condition being different from zero
...
```{r}
null_test_adults_diff_mouse_bear_al <-  update(bm_test_adults_diff_mouse_bear_al, formula = ~ .-condition_c:diff_mouse_bear)
summary(null_test_adults_diff_mouse_bear_al)
test_m_comparison_adults_diff_mouse_bear_al <- brms::bayes_factor(bm_test_adults_diff_mouse_bear_al, null_test_adults_diff_mouse_bear_al)
...
Looking_all_trials <- ggplot(summarize_participant,aes(as.factor(trial_num),absolute_looking))+
  ...
  geom_half_boxplot(data=filter(summarize_participant,trial_num=="1"),side="l",nudge=0.15,width=0.4,errorbar.draw=F)+
  geom_half_boxplot(data=filter(summarize_participant,trial_num=="2"),side="l",nudge=0.15,width=0.4,errorbar.draw=F)+
  geom_half_boxplot(data=filter(summarize_participant,trial_num=="3"),side="l",nudge=0.15,width=0.4,errorbar.draw=F)+
  geom_half_boxplot(data=filter(summarize_participant,trial_num=="4"),side="l",nudge=0.15,width=0.4,errorbar.draw=F)+
  geom_half_boxplot(data=filter(summarize_participant,trial_num=="5"),side="l",nudge=0.15,width=0.4,errorbar.draw=F)+
  geom_half_boxplot(data=filter(summarize_participant,trial_num=="6"),side="l",nudge=0.15,width=0.4,errorbar.draw=F)+
  stat_summary(fun.data="mean_cl_boot",size=1,color="black")+
  facet_wrap(~age_cohort)+
  theme_set(theme_cowplot(font_size=24))+
  geom_hline(yintercept=0,linetype="dashed")+
...
test_first_trial_half <- ggplot(summarize_participant_test_first_trial_half,aes(as.factor(analysis_window),prop_exit,color=condition))+
  ...
  geom_half_boxplot(data=filter(summarize_participant_test_first_trial_half,analysis_window=="1"),side="l",nudge=0.15,width=0.4,errorbar.draw=F)+
  geom_half_boxplot(data=filter(summarize_participant_test_first_trial_half,analysis_window=="2"),side="r",nudge=0.15,width=0.4,errorbar.draw=F)+
  stat_summary(fun.data="mean_cl_boot",size=1,color="black")+
    geom_hline(yintercept=0.5,linetype="dashed")+
  theme_cowplot()+
  facet_wrap(condition~age_cohort)+
