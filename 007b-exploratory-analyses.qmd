...
saveRDS(bm_aoi_toddlers_both, file = here(RESULTS_FOLDER, "bayes_model_fits", "bm_aoi_toddlers_both.rds"))
```
...
saveRDS(bm_aoi_toddlers_both_null, file=here(RESULTS_FOLDER,"bayes_model_fits","bm_fam_aoi_toddlers_null.rds"))
...
saveRDS(bm_aoi_adults_both_null, file=here(RESULTS_FOLDER,"bayes_model_fits","bm_fam_aoi_adults_null.rds"))
...
saveRDS(bm_aoi_toddlers_both_order, file = here(RESULTS_FOLDER, "bayes_model_fits", "bm_aoi_toddlers_both_order.rds"))
```
...
saveRDS(bm_aoi_toddlers_both_order_null, file=here(RESULTS_FOLDER,"bayes_model_fits","bm_aoi_toddlers_both_order_null.rds"))
...
saveRDS(bm_aoi_adults_both_order, file = here(RESULTS_FOLDER, "bayes_model_fits", "bm_aoi_adults_both_order.rds"))
```
...
saveRDS(bm_aoi_adults_both_order_null, file=here(RESULTS_FOLDER,"bayes_model_fits","bm_aoi_adults_both_order_null.rds"))
...
saveRDS(bm_aoi_toddlers_correct_final_fam_trial, file = here(RESULTS_FOLDER, "bayes_model_fits", "bm_aoi_toddlers_correct_final_fam_trial.rds"))
```
...
bm_aoi_toddlers_correct_final_fam_trial_age_effect <- bm_aoi_toddlers_correct_final_fam_trial %>%
  spread_draws(b_age_mo_c, sigma) %>%
  mean_hdi(.width = 0.95)

#cache
saveRDS(bm_aoi_toddlers_correct_final_fam_trial_age_effect, file=here(RESULTS_FOLDER,"bm_aoi_toddlers_correct_final_fam_trial_age_effect.rds"))

bm_aoi_toddlers_correct_final_fam_trial_condition_age_interaction <- bm_aoi_toddlers_correct_final_fam_trial %>%
  spread_draws(`b_condition_c:age_mo_c`, sigma) %>%
  mean_hdi(.width = 0.95)

#cache
saveRDS(bm_aoi_toddlers_correct_final_fam_trial_condition_age_interaction, file=here(RESULTS_FOLDER,"bm_aoi_toddlers_correct_final_fam_trial_condition_age_interaction.rds"))
```
...
saveRDS(bm_aoi_toddlers_correct_final_fam_trial_null, file=here(RESULTS_FOLDER,"bayes_model_fits","bm_aoi_toddlers_correct_final_fam_trial_null.rds"))
...
saveRDS(bm_aoi_adults_correct_final_fam_trial, file = here(RESULTS_FOLDER, "bayes_model_fits", "bm_aoi_adults_correct_final_fam_trial.rds"))
```
...
saveRDS(bm_aoi_adults_correct_final_fam_trial_null, file=here(RESULTS_FOLDER,"bayes_model_fits","bm_aoi_adults_correct_final_fam_trial_null.rds"))
...
saveRDS(bm_aoi_toddlers_sufficient_fam_prop_looking, file = here(RESULTS_FOLDER, "bayes_model_fits", "bm_aoi_toddlers_sufficient_fam_prop_looking.rds"))
```
...
bm_aoi_toddlers_sufficient_fam_prop_looking_age_effect <- bm_aoi_toddlers_sufficient_fam_prop_looking %>%
  spread_draws(b_age_mo_c, sigma) %>%
  mean_hdi(.width = 0.95)

#cache
saveRDS(bm_aoi_toddlers_sufficient_fam_prop_looking_age_effect, file=here(RESULTS_FOLDER,"bm_aoi_toddlers_sufficient_fam_prop_looking_age_effect.rds"))

bm_aoi_toddlers_sufficient_fam_prop_looking_condition_age_interaction <- bm_aoi_toddlers_sufficient_fam_prop_looking %>%
  spread_draws(`b_condition_c:age_mo_c`, sigma) %>%
  mean_hdi(.width = 0.95)

#cache
saveRDS(bm_aoi_toddlers_sufficient_fam_prop_looking_condition_age_interaction, file=here(RESULTS_FOLDER,"bm_aoi_toddlers_sufficient_fam_prop_looking_condition_age_interaction.rds"))
```
...
saveRDS(bm_aoi_toddlers_sufficient_fam_prop_looking_null, file=here(RESULTS_FOLDER,"bayes_model_fits","bm_aoi_toddlers_sufficient_fam_prop_looking_null.rds"))
...
saveRDS(bm_aoi_adults_sufficient_fam_prop_looking, file = here(RESULTS_FOLDER, "bayes_model_fits", "bm_aoi_adults_sufficient_fam_prop_looking.rds"))
```
...
saveRDS(bm_aoi_adults_sufficient_fam_prop_looking_null, file=here(RESULTS_FOLDER, "bayes_model_fits", "bm_aoi_adults_sufficient_fam_prop_looking_null.rds"))
...
saveRDS(bm_aoi_toddlers_method, file = here(RESULTS_FOLDER, "bayes_model_fits", "bm_aoi_toddlers_method.rds"))
```
...
saveRDS(bm_aoi_toddlers_method_null, file=here(RESULTS_FOLDER, "bayes_model_fits", "bm_aoi_toddlers_method_null.rds"))
...
saveRDS(bm_aoi_adults_method, file = here(RESULTS_FOLDER, "bayes_model_fits", "bm_aoi_adults_method.rds"))
```
Summarize outcomes
...
saveRDS(bm_aoi_adults_method_null, file=here(RESULTS_FOLDER, "bayes_model_fits", "bm_aoi_adults_method_null.rds"))
...
saveRDS(bm_test_shifts_age_cohort, file = here(RESULTS_FOLDER, "bayes_model_fits", "bm_test_shifts_age_cohort.rds"))
```
...
bm_test_shifts_age_cohort_age_cohort_condition_interaction <- bm_test_shifts_age_cohort %>%
  ...
  mean_hdi(.width = 0.95) ### currently giving me an NA here
...
saveRDS(bm_test_shifts_age_cohort_null, file=here(RESULTS_FOLDER,"bayes_model_fits", "bm_test_shifts_age_cohort_null.rds"))
...
saveRDS(bm_test_toddlers_shifts_al_null, file=here(RESULTS_FOLDER,"bayes_model_fits","bm_test_toddlers_shifts_al_null.rds"))
...
saveRDS(bm_test_adults_shifts_al, file = here(RESULTS_FOLDER, "bayes_model_fits", "bm_test_adults_shifts_al.rds"))
```
...
saveRDS(bm_test_adults_shifts_al_null, file=here(RESULTS_FOLDER, "bayes_model_fits", "bm_test_adults_shifts_al_null.rds"))
...
saveRDS(bm_test_toddlers_diff_mouse_bear_al, file = here(RESULTS_FOLDER, "bayes_model_fits", "bm_test_toddlers_diff_mouse_bear_al.rds"))
```
...
```{r}
bm_test_toddlers_diff_mouse_bear_al_null <-  update(bm_test_toddlers_diff_mouse_bear_al, formula = ~ .-diff_mouse_bear)
summary(bm_test_toddlers_diff_mouse_bear_al_null)

saveRDS(bm_test_toddlers_diff_mouse_bear_al_null, file=here(RESULTS_FOLDER, "bayes_model_fits", "bm_test_toddlers_diff_mouse_bear_al_null.rds"))
...
saveRDS(bm_test_adults_diff_mouse_bear_al, file = here(RESULTS_FOLDER, "bayes_model_fits", "bm_test_adults_diff_mouse_bear_al.rds"))
```
...
saveRDS(bm_test_adults_diff_mouse_bear_al_null, file=here(RESULTS_FOLDER, "bayes_model_fits", "bm_test_adults_diff_mouse_bear_al_null.rds"))
