...
summarize_participant_test_both_trials <- summarize_participant_test_both_trials %>% 
  ...
  ungroup() %>%
 mutate(order_c=case_when(
     (trial_num==5 & condition=="knowledge") | (trial_num==6 & condition=="ignorance") ~ -0.5, 
     (trial_num==5 & condition=="ignorance") | (trial_num==6 & condition=="knowledge") ~ 0.5,
     TRUE ~ NA))
```
