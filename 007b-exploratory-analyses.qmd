...
# List all RDS files in the results folder
rds_files <- list.files(model_fits_dir, pattern = "\\.rds$", full.names = TRUE)
...
bm_fam_toddlers_location_al <- brm(
  prop_exit_adj ~ 1 + prev_location_c * familiarization_trial_num_4 +
...
bm_fam_toddlers_location_al_null <- update(bm_fam_toddlers_location_al, 
                                          formula = ~ . - prev_location_c:familiarization_trial_num_4,
                                          cores = n_cores)
