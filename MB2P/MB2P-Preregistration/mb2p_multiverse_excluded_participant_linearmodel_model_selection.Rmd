...
data_pupillometry <- data_pupillometry |> 
  ...
  select(participant_id, participant_lab_id, lab_id, age_cohort, t, x, y, pupil_left, pupil_right, condition, t_norm, trial_num, participant_gender, eyetracker_type, outcome, pilot, session_error, age_exclusion, sufficient_fam_trials, valid_second_test_trial, valid_first_test_trial) |>
...
grand_avg <- data_df5 |> 
  ...
  summarize(
    grand_average = mean(average_z, na.rm = TRUE),  
