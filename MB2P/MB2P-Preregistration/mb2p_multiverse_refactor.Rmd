...
data_pupillometry_test <- data_pupillometry %>% left_join(summarize_participant_test_both_trials %>% select("participant_lab_id", "trial_num", "prop_exit"), by = c( "participant_lab_id", "trial_num"))

rm(summarize_participant_test_first_trial)
```
