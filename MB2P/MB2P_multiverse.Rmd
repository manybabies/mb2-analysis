...
## The data needed for multiverse analysis.
...
The following script specifies the preprocessing and analysis steps of the multiverse approach applied to MB2P (see Calignano, Girardi, and Altoé, 2023).
