...
#! Why are there still such large values even with Eyelink-data removed?
    ...
    d |> 
      ...
      mutate(pupil_left = rollapply(pupil_left, width = WINDOW_SIZE, 
             ...
             pupil_right = rollapply(pupil_right, width = WINDOW_SIZE, 
                                     ...
                                     fill = NA, align = "right")) |> 
      rowwise() |> 
      mutate(average = mean(c(pupil_left, pupil_right), na.rm = TRUE)) |> # NEW: need to update average after applying rolling average; switched to liberal avg #! DONE?
      ungroup() 
  }))
