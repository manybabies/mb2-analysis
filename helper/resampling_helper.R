...
resample_xy_trial <- function(df_trial, timepoint_col_name = "t_norm",trial_col_name = "event_num") {
  MISSING_CONST <- -10000
  # set sample rates
  SAMPLE_RATE = 40 # Hz
...
resample_times <- function(df_table,timepoint_col_name = "t_norm",trial_col_name = "event_num") {
  ...
  # first check if this data frame has all the correct columns required for
  # re-sampling
  required_columns <- c(trial_col_name, "participant_id", timepoint_col_name, "x", "y")
