...
###Toddler data###
Skid_toddlers <- read_excel(here(DATA_DIR,"raw_data","SkidLSDLab_toddlers_eyetrackingdata.xlsx"))

Skid_toddlers[Skid_toddlers=="-"]<-NA
Skid_toddlers$`Point of Regard Right X [px]`[Skid_toddlers$`Point of Regard Right X [px]`==0]<-NA
Skid_toddlers$`Point of Regard Left X [px]`[Skid_toddlers$`Point of Regard Left X [px]`==0]<-NA
Skid_toddlers$`Point of Regard Right Y [px]`[Skid_toddlers$`Point of Regard Right Y [px]`==0]<-NA
Skid_toddlers$`Point of Regard Left Y [px]`[Skid_toddlers$`Point of Regard Left Y [px]`==0]<-NA
...
Skid_toddlers$`Pupil.Diameter.Left..mm.`[Skid_toddlers$`Pupil.Diameter.Left..mm.`==0]<-NA
Skid_toddlers$`Pupil.Diameter.Right..mm.`[Skid_toddlers$`Pupil.Diameter.Right..mm.`==0]<-NA
...
###Adult data###
Skid_adults <- read_excel(here(DATA_DIR,"raw_data","SkidLSDLab_adults_eyetrackingdata.xlsx"))

Skid_adults[Skid_adults=="-"]<-NA
Skid_adults$`Point of Regard Right X [px]`[Skid_adults$`Point of Regard Right X [px]`==0]<-NA
Skid_adults$`Point of Regard Left X [px]`[Skid_adults$`Point of Regard Left X [px]`==0]<-NA
Skid_adults$`Point of Regard Right Y [px]`[Skid_adults$`Point of Regard Right Y [px]`==0]<-NA
Skid_adults$`Point of Regard Left Y [px]`[Skid_adults$`Point of Regard Left Y [px]`==0]<-NA
...
Skid_adults$`Pupil.Diameter.Left..mm.`[Skid_adults$`Pupil.Diameter.Left..mm.`==0]<-NA
Skid_adults$`Pupil.Diameter.Right..mm.`[Skid_adults$`Pupil.Diameter.Right..mm.`==0]<-NA
