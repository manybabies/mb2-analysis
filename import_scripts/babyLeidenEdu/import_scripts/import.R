...
#### Adult data ####
data_adults <- read_tsv(here(DATA_DIR, "raw_data", "babyLeidenEdu_adults_eyetrackingdata.tsv"))
...
#### Toddler data ####
data_toddlers <- read_tsv(here(DATA_DIR, "raw_data", "babyLeidenEdu_toddlers_eyetrackingdata.tsv"))
