...
#### Adult data ####
data_adults <- read_delim(here(DATA_DIR, "raw_data/babylabTrento_adults_eyetrackingdata.tsv"), delim = "\t", escape_double = FALSE, locale = locale(decimal_mark = ",", grouping_mark = ""), trim_ws = TRUE)
...
#### Toddler data ####
data_toddlers <- data_adults <- read_delim(here(DATA_DIR, "raw_data/babylabTrento_toddlers_eyetrackingdata.tsv"), delim = "\t", escape_double = FALSE, locale = locale(decimal_mark = ",", grouping_mark = ""), trim_ws = TRUE)
