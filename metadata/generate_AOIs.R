...
generate_aois <- function(screen_width = 1280, 
                          screen_height = 1024,
                          video_width = 1280,
                          video_height = 960, 
                          size = "big") {
  ...
  if (size == "small") {
    ...
    aoi_regions = tibble(
      ...
      l_y_max = ((video_height*9)/16) + ((screen_height-video_height)/2),
      l_y_min = video_height + ((screen_height-video_height)/2),
      r_x_max = video_width + (screen_width-video_width)/2,
      r_x_min = ((video_width*9)/16) + (screen_width-video_width)/2,
      r_y_max = ((video_height*9)/16) + ((screen_height-video_height)/2),
      r_y_min = video_height + ((screen_height-video_height)/2))
  }
}
