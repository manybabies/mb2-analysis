...
In contrast, for adults, the Bayes Factor of `r  format_bayes_factor(test_m_comparison_shifts_adults$bf)` provided extreme evidence in favor of the full model that included condition as fixed effect. In the knowledge condition, adults showed more gaze shifts than in the ignorance condition.
These findings demonstrate a robust condition effect in adults but not in toddlers.
