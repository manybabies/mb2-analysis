...
```{r Results familiarization PTL toddlers, warning=FALSE}

source(here('helper','ensure_repo_structure.R'))
results_path <- here("results")
summarize_fam_aoi_overall <- readRDS(here(results_path,"summary_fam_aoi_overall.rds"))

fam_m_comparison_PTL_toddlers <- readRDS(here(results_path,"fam_m_comparison_PTL_toddlers.rds"))
...
```{r Results familiarization PTL adults, warning=FALSE}

source(here('helper','ensure_repo_structure.R'))

fam_m_comparison_PTL_adults <- readRDS(here(results_path,"fam_m_comparison_PTL_adults.rds"))
```
...
```{r Results familiarization FL toddlers, warning=FALSE}

source(here('helper','ensure_repo_structure.R'))

fam_m_comparison_FL_toddlers <- readRDS(here(results_path,"fam_m_comparison_FL_toddlers.rds"))
```
...
```{r Results familiarization FL adults, warning=FALSE}

source(here('helper','ensure_repo_structure.R'))

fam_m_comparison_FL_adults <- readRDS(here(results_path,"fam_m_comparison_FL_adults.rds"))
```
