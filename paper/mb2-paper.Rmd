...
<!-- MSS: What should we do with this? For adults: difference between conditions for boxes larger than for exits
...
For toddlers, the fixed effect of difference in mouse-bear looking on anticipatory looking was essentially zero, Estimate = `r round(b_toddlers_diff_mouse_bear_estimate_diff_mouse_bear, 3)`, as was the interaction between condition and diff_mouse_bear, Estimate = `r round(b_toddlers_diff_mouse_bear_estimate_diff_mouse_bear_interaction, 3)`. These results indicate that neither the main effect of fixation time differences nor its interaction with condition meaningfully predicted anticipatory looking.
