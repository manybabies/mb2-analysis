...
In addition, toddlers' mean PTL of `r filter(summary_fam_aoi_overall, age_cohort=="toddlers")$mean_target_looking` significantly differed from chance, *t*(`r filter(summary_fam_aoi_overall, age_cohort=="toddlers")$df`) = `r filter(summary_fam_aoi_overall, age_cohort=="toddlers")$tval`, *p* `r printp(filter(summary_fam_aoi_overall, age_cohort=="toddlers")$p.value)`, suggesting that toddlers successfully anticipated during the familiarization trials.

##### Adults

Next, we used a Bayesian mixed effects model to predict PTL based on trial number (1-4) for adults, again with random effects for lab and participants and random slopes for trial number for each. The Bayes factor comparing this model to the simpler null model without the intercept was estimated to be `r printnum(fam_m_comparison_PTL_adults$bf)`, strongly favoring the base model over the null model. These results suggest a significant effect of trial number on PTL, with the positive coefficient indicating an increase in target looks across the familiarization trials. The strong Bayes factor provides substantial evidence in support of the base model, highlighting its robustness in explaining the data compared to the null model. In addition, adults' mean PTL of `r filter(summary_fam_aoi_overall, age_cohort=="adults")$mean_target_looking` significantly differed from chance, *t*(`r filter(summary_fam_aoi_overall, age_cohort=="adults")$df`) = `r filter(summary_fam_aoi_overall, age_cohort=="adults")$tval`, *p* `r printp(filter(summary_fam_aoi_overall, age_cohort=="adults")$p.value)`, suggesting that adults successfully anticipated during the familiarization trials.
...
Across familiarization trials, the proportion of first looks to the target exit significantly differed from chance (`r filter(summarize_overall_familiarization_first_look_across_trials, age_cohort=="toddlers")$prop_target_first_look`, 95% CI = [`r filter(summarize_overall_familiarization_first_look_across_trials, age_cohort=="toddlers")$lower_ci`,`r filter(summarize_overall_familiarization_first_look_across_trials, age_cohort=="toddlers")$upper_ci`], *t*(`r filter(summarize_overall_familiarization_first_look_across_trials, age_cohort=="toddlers")$df`) = `r filter(summarize_overall_familiarization_first_look_across_trials, age_cohort=="toddlers")$tval`, *p* `r printp(filter(summarize_overall_familiarization_first_look_across_trials, age_cohort=="toddlers")$p.value)`), suggesting that toddlers successfully anticipated during the familiarization trials.
...
The strong Bayes factor provides substantial evidence in support of the base model, highlighting its robustness in explaining the data compared to the null model.
The proportion of first looks to the target exit differed significantly from chance overall during familiarization (`r filter(summarize_overall_familiarization_first_look_across_trials, age_cohort=="adults")$prop_target_first_look`, 95% CI = [`r filter(summarize_overall_familiarization_first_look_across_trials, age_cohort=="adults")$lower_ci`,`r filter(summarize_overall_familiarization_first_look_across_trials, age_cohort=="adults")$upper_ci`], *t*(`r filter(summarize_overall_familiarization_first_look_across_trials, age_cohort=="adults")$df`) = `r filter(summarize_overall_familiarization_first_look_across_trials, age_cohort=="adults")$tval`, *p* `r printp(filter(summarize_overall_familiarization_first_look_across_trials, age_cohort=="adults")$p.value)`).
...
As first model, we used a Bayesian mixed effects models to predict PTL based on condition for toddlers, with random effects for lab and participants and random slopes for trial number for each. The Bayes factor comparing this model to the simpler null model without the intercept was estimated to be `r printnum(fam_m_comparison_PTL_toddlers$bf)`, strongly favoring the base model over the null model. Table 4 shows the statistics for regression coefficients of the base model. These results suggest a significant effect of trial number on PTL, with the negative coefficient indicating a decrease in PTL across the familiarization trials. The strong Bayes factor provides substantial evidence in support of the base model, highlighting its robustness in explaining the data compared to the null model.
In addition, toddlers' mean PTL of `r filter(summary_fam_aoi_overall, age_cohort=="toddlers")$mean_target_looking` significantly differed from chance, *t*(`r filter(summary_fam_aoi_overall, age_cohort=="toddlers")$df`) = `r filter(summary_fam_aoi_overall, age_cohort=="toddlers")$tval`, *p* `r printp(filter(summary_fam_aoi_overall, age_cohort=="toddlers")$p.value)`, suggesting that toddlers successfully anticipated during the familiarization trials.
