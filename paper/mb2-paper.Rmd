...
#remove all pilot participants
d_participants <- d_participants %>% filter(pilot=="no")

n_before_exclusion <- d_participants %>% summarise(n = length(unique(participant_lab_id)))
n_before_exclusion_adults <- d_participants %>% filter(age_cohort=="adults") %>% summarise(n = length(unique(participant_lab_id)))
n_before_exclusion_toddlers <- d_participants %>% filter(age_cohort=="toddlers") %>% summarise(n = length(unique(participant_lab_id)))

n_toddlers_no_session_error <- d_participants %>% filter(age_cohort=="toddlers" & session_error=="noerror") %>% summarise(n = length(unique(participant_lab_id)))

n_adults_no_session_error <- d_participants %>% filter(age_cohort=="adults" & session_error=="noerror") %>% summarise(n = length(unique(participant_lab_id)))

n_adults_included <- d_participants %>% filter(age_cohort=="adults" & session_error=="noerror" & trial_based_error=="no") %>% summarise(n = length(unique(participant_lab_id)))

n_toddlers_included <- d_participants %>% filter(age_cohort=="toddlers" & session_error=="noerror" & trial_based_error=="no") %>% summarise(n = length(unique(participant_lab_id)))
