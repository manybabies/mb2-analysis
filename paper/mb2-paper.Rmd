...
n_before_exclusion <- combined_demo %>% summarise(n = length(unique(unique_participant_id)))
n_before_exclusion_adults <- combined_demo %>% filter(age_cohort=="adults") %>% summarise(n = length(unique(unique_participant_id)))
n_before_exclusion_toddlers <- combined_demo %>% filter(age_cohort=="toddlers") %>% summarise(n = length(unique(unique_participant_id)))

n_adults_included <- data_preprocessed %>% filter(age_cohort=="adults") %>% summarise(n = length(unique(unique_participant_id)))
n_toddlers_included <- data_preprocessed %>% filter(age_cohort=="toddlers") %>% summarise(n = length(unique(unique_participant_id)))

n_labs <- combined_demo %>% summarise(n = length(unique(lab_id)))

n_labs_adults <- combined_demo %>% filter(age_cohort=="adults") %>% summarise(n = length(unique(lab_id)))

n_labs_toddlers <- combined_demo %>% filter(age_cohort=="toddlers") %>% summarise(n = length(unique(lab_id)))
