...
The Bayes factor comparing the full model to the simpler model was estimated to be `r printnum(fam_m_comparison_FL_toddlers$bf)`, strongly favoring the full model over the null model.
