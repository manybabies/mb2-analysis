...
Our final dataset will consist of 1200 participants, with an overall exclusion rate of XYZ\% (toddlers: XYZ\%, adults: XYZ\%). Tables 1 A. and B. show the distribution of included participants across labs, eye-tracking methods, and ages. A final sample of 507 toddlers (XX\% female) that will have been tested in 37 labs (mean lab sample size = 16.90, SD =5.76, range: 6 - 34) will be analyzed. The average age of toddlers in the final sample will be 22.54 months (SD: 2.75, range: 13.47 - 35.25). The final sample size of included adults will be N = 649 (XX\% female), tested in 34 labs (mean lab sample size = 21.55, SD = 12.30, range: 8 - 65). Their mean age will be 24.61 years (SD: 8.09, range: 17 - 69).
