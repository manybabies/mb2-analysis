...
The Bayes factor comparing the full model to the simpler model was estimated to be BF = 15.9, favoring the full model over the null model.
...
\url{https://docs.google.com/document/d/1tuiLXti8pgVyzX_V2X3RTUzb51P9Y2KMn4AeNkE8CuI/edit?tab=t.0}
