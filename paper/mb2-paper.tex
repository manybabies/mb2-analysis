...
As first model, we used a Bayesian mixed effects models to predict PTL based on trial number (1-4) for toddlers, with random effects for lab and participants and random slopes for trial number for each. The Bayes factor comparing this model to the simpler null model without the intercept was estimated to be 200,755,613.82, strongly favoring the base model over the null model. See also Table 3 for regression coefficients for the base model. These results suggest a significant effect of trial number on PTL, with the negative coefficient indicating a decrease in PTL across the familiarization trials. The strong Bayes factor provides substantial evidence in support of the base model, highlighting its robustness in explaining the data compared to the null model.

\hypertarget{adults}{%
\subparagraph{Adults}\label{adults}}

Next, we used a Bayesian mixed effects model to predict PTL based on trial number (1-4) for adults, again with random effects for lab and participants and random slopes for trial number for each. The Bayes factor comparing this model to the simpler null model without the intercept was estimated to be 45,181,827,193,246,836,521,966,638,202,880.00, strongly favoring the base model over the null model. These results suggest a significant effect of trial number on PTL, with the positive coefficient indicating an increase in target looks across the familiarization trials. The strong Bayes factor provides substantial evidence in support of the base model, highlighting its robustness in explaining the data compared to the null model.
...
The Bayes factor comparing the base model to the simpler model was estimated to be 150,931,286,964,478,876,319,744.00, strongly favoring the base model over the null model.
...
\hypertarget{proportion-of-total-relative-looking-time-1}{%
\paragraph{Proportion of total relative looking time}\label{proportion-of-total-relative-looking-time-1}}

\hypertarget{toddlers-2}{%
\subparagraph{Toddlers}\label{toddlers-2}}

As first model, we used a Bayesian mixed effects models to predict PTL based on condition and age for toddlers, with random effects for lab and participants and random slopes for trial number for each. The Bayes factor comparing this model to the simpler null model without the intercept was estimated to be 200,755,613.82, strongly favoring the base model over the null model. Table 4 shows the statistics for regression coefficients of the base model. These results suggest a significant effect of condition on PTL, with the negative coefficient indicating a decrease in PTL across the familiarization trials. The strong Bayes factor provides substantial evidence in support of the base model, highlighting its robustness in explaining the data compared to the null model.

\hypertarget{adults-2}{%
\subparagraph{Adults}\label{adults-2}}

Next, we used a Bayesian mixed effects model to predict PTL based on trial number (1-4) for adults, again with random effects for lab and participants and random slopes for trial number for each. The Bayes factor comparing this model to the simpler null model without the intercept was estimated to be 45,181,827,193,246,836,521,966,638,202,880.00, strongly favoring the base model over the null model. These results suggest a significant effect of trial number on PTL, with the positive coefficient indicating an increase in target looks across the familiarization trials. The strong Bayes factor provides substantial evidence in support of the base model, highlighting its robustness in explaining the data compared to the null model.

\hypertarget{proportion-of-first-looks-1}{%
\paragraph{Proportion of first looks}\label{proportion-of-first-looks-1}}

\hypertarget{toddlers-3}{%
\subparagraph{Toddlers}\label{toddlers-3}}

Investigating proportion of first looks for toddlers, we again used a Bayesian mixed effects model to predict target looks based on trial number (1-4), with random effects for lab and participants and random slopes for trial number for each. The Bayes factor comparing the base model to the simpler model was estimated to be 45,181,827,193,246,836,521,966,638,202,880.00, strongly favoring the base model over the null model. There was a significant effect of trial number on proportion of first looks, with the negative coefficient indicating a decrease in target looks across the familiarization trials. The strong Bayes factor provides substantial evidence in support of the base model, highlighting its robustness in explaining the data compared to the null model. Using binomal test, the proportion of first looks of 0.69 significantly differed from chance,

\hypertarget{adults-3}{%
\subparagraph{Adults}\label{adults-3}}

Comparing the Bayesian mixed effects model of adults predicting proportion of first looks based on trial number (1-4), with random effects for lab and participants and random slopes for trial number for each with the simpler model without an intercept, we computed a Bayes factor of 45,181,827,193,246,836,521,966,638,202,880.00, strongly favoring the base model over the null model. There was a significant effect of trial number on proportion of first looks, with the positive coefficient indicating an increase in proportion of first target looks across the familiarization trials. The strong Bayes factor provides substantial evidence in support of the base model, highlighting its robustness in explaining the data compared to the null model. Using binomal test, the proportion of first looks of 0.69 significantly differed from chance,
...
\hypertarget{comparing-the-looking-patterns-of-toddlers-and-adults-during-the-location-change-of-the-mouse.}{%
\paragraph{Comparing the looking patterns of toddlers and adults during the location change of the mouse.}\label{comparing-the-looking-patterns-of-toddlers-and-adults-during-the-location-change-of-the-mouse.}}

We fitted a Bayesian mixed-effects model to examine the relationship between the number of shifts and age cohort during location change of the mouse, while accounting for random effects by lab\_id. The fixed effect of age cohort on number of shifts is estimated to be 0.37, suggesting a higher number of shifts for adults compared to toddlers (see Figure 6). Comparing this model to a simpler model without age cohort, a Bayes Factor (BF) of 30,971.48 was obtained. This provides extremely strong evidence in favor of including age cohort in the model.

\begin{figure}

{\centering \includegraphics[width=6.8in]{/Users/mellischreiner/Documents/GitHub/mb2-analysis/paper/Figure6} 

}

\caption{Number of shifts between mouse and bear during location change of mouse in the test phase for toddlers and adults.}\label{fig:fig6}
\end{figure}

\hypertarget{al-as-a-function-of-gaze-shifts-during-location-change.}{%
\paragraph{AL as a function of gaze shifts during location change.}\label{al-as-a-function-of-gaze-shifts-during-location-change.}}

In order to examine the effect of condition and the number of shifts on anticipatory looking, we fitted a Bayesian mixed-effects model. The dependent variable was the proportion of target looking. The fixed effects included the main effects of condition (condition\_c), the number of shifts (num\_shifts), and their interaction (condition\_c * num\_shifts). We also included random intercepts and slopes for number of shifts (age\_cohort\_c) within each participant, allowing us to account for the hierarchical structure of the data and potential variability between participants.
...
\leavevmode\vadjust pre{\hypertarget{ref-baillargeon2018invited}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-baillargeon2010false}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-barone2019infants}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-burnside2018implicit}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-buttelmann2009eighteen}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-carruthers2013mindreading}{}}%
Carruthers, P. (2013). Mindreading in infancy. \emph{Mind \& Language}, \emph{28}(2), 141--172.

\leavevmode\vadjust pre{\hypertarget{ref-csibra2007obsessed}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-dorrenberg2018not}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-elsner2021infants}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-ganglmayer2019infants}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-gergely2003teleological}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-gergely1995taking}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-gliga2014early}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-grosse2017implicit}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-hayashi2020macaques}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-kampis2021two}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-kano2019great}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-kiraly2018retrospective}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-knudsen201218}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-krupenye2016great}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-kulke2018implicit}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-kulke2021implicit}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-kulke2019can}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-kulke2018implicitdata}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-kulke2019testing}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-kulke2018robust}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-kulke2019implicit}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-leslie2005developmental}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-liszkowski2007pointing}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-luo200712}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-luo2010toward}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-meristo2012belief}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-o1996two}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-poulin2018infants}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-powell2018replications}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-priewasser2020mistaken}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-priewasser2018helping}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-schneider2012eye}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-schneider2012cognitive}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-schneider2013temporally}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-senju201118}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-senju2009mindblind}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-southgate2010motor}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-southgate2014belief}{}}%
Southgate, V., \& Vernetti, A. (2014). Belief-based action prediction in preverbal infants. \emph{Cognition}, \emph{130}(1), 1--10.

\leavevmode\vadjust pre{\hypertarget{ref-surian2007attribution}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-surian2020domain}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-thoermer2012continuity}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-trauble2010early}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-wellman2001theory}{}}%
Wellman, H. M., \& Cross, D. (2001). Theory of mind and conceptual change. \emph{Child Development}, \emph{72}(3), 702--707.

\leavevmode\vadjust pre{\hypertarget{ref-wiesmann2018longitudinal}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-woodward2000twelve}{}}%
