...
As first model, we used a Bayesian mixed effects models to predict PTL based on trial number (1-4) for toddlers, with random effects for lab and participants and random slopes for trial number for each. The Bayes factor comparing this model to the simpler null model without the intercept was estimated to be \textgreater{} 1000, strongly favoring the full model over the null model. See also Table 3 for regression coefficients for the base model. These results suggest a significant effect of trial number on PTL, with the negative coefficient indicating a decrease in PTL across the familiarization trials.

\hypertarget{adults}{%
\subparagraph{Adults}\label{adults}}

Next, we used a Bayesian mixed effects model to predict PTL based on trial number (1-4) for adults, again with random effects for lab and participants and random slopes for trial number for each. The Bayes factor for the full model against the null model was \textgreater{} 1000, suggesting strong evidence for the full model. These results suggest a significant effect of trial number on PTL, with the positive coefficient indicating an increase in target looks across the familiarization trials.
...
The Bayes factor comparing the full model to the simpler model was estimated to be \textgreater{} 1000, strongly favoring the full model over the null model.
...
Investigating proportion of first looks for toddlers, we again used a Bayesian mixed effects model to predict target looks based on condition, with random effects for lab. The Bayes factor comparing the full model to the simpler model was estimated to be BF = 2.7, providing no substantial evidence in favor of the full model over the null model.
...
\leavevmode\vadjust pre{\hypertarget{ref-apperly2009humans}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-buttelmann201914}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-buttelmann2015you}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-clements1994implicit}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-dorrenberg2019reliability}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-fabricius2010true}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-flavell1988development}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-flavell1981young}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-frank2012measuring}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-hare2001chimpanzees}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-heyes2014submentalizing}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-hogrefe1986ignorance}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-horschler2020non}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-kaminski2008chimpanzees}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-kampis2020developing}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-karg2015goggles}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-low2013attributing}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-martin2016cognitive}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-mellers2001frequency}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-papoutsaki2016proceedings}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-perner2005infants}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-ruffman1996children}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-schneider2017current}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-scott2009penguin}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-scott2015infants}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-surian2012will}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-yang2002latency}{}}%
