...
kable(bayesian_results, caption = tS3_caption, format = "latex", booktabs=TRUE, align=c("l","l","l","r","l","l"),col.names = c("Age Cohort","Phase", "Prior", "Bayes Factor","Parameter Estimates", "Sensitivity"),rep("c",4)) %>%
