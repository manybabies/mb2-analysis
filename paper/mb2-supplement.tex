...
\caption{Effect sizes of simulated experiments. \newline{} \textit{Note}. Ordered by effect size (from left to right), 95\% credible intervals for the key effect (in logit space) for our simulated experiments that use first look as the dependent variable.}\label{fig:figS5}
\end{figure}
...
\toprule
Age Cohort & Phase & Prior & Bayes Factor & Parameter Estimates\\
\midrule
Toddlers & Familiarization & Weakly Informative & 7180 & Intercept: 0.44, Main Effect: -0.22\\
 &  & Less Informative & 10763 & Intercept: 0.45, Main Effect: -0.23\\
Adults &  & Weakly Informative & 2242713044 & Intercept: 1.03, Main Effect: 0.38\\
 &  & Less Informative & 5201436143831125852160 & Intercept: 1.06, Main Effect: 0.40\\
Toddlers & Test & Weakly Informative & 2.4 & Intercept: 0.53, Main Effect: 0.53, Interaction: -0.13\\
\addlinespace
 &  & Less Informative & 1 & Intercept: 0.57, Main Effect: 0.56, Interaction: -0.14\\
Adults &  & Weakly Informative & 157455 & Intercept: 0.05, Main Effect: -0.89\\
 &  & Less Informative & 1889 & Intercept: 0.06, Main Effect: -0.96\\
\bottomrule
\end{tabular}
...
\caption{\label{tab:Results table of Bayesian regression models for al as a function of the difference in mouse-bear looking}Results of the Bayesian mixed effects models for anticipatory looking as a function of the difference in mouse-bear looking.}\\
\toprule
...
\midrule
\endfirsthead
\caption*{\normalfont{Table \ref{tab:Results table of Bayesian regression models for al as a function of the difference in mouse-bear looking} continued}}\\
\toprule
model & \multicolumn{1}{c}{term} & \multicolumn{1}{c}{estimate} & \multicolumn{1}{c}{est\_error} & \multicolumn{1}{c}{lower\_ci} & \multicolumn{1}{c}{upper\_ci} & \multicolumn{1}{c}{rhat}\\
\midrule
\endhead
toddlers diff & Intercept & 0.57 & 0.03 & 0.52 & 0.62 & 1.00\\
 & Condition & 0.08 & 0.04 & -0.01 & 0.17 & 1.00\\
 & Difference Mouse-Bear & 0.01 & 0.01 & 0.00 & 0.03 & 1.00\\
 & Condition:Difference Mouse-Bear & 0.01 & 0.02 & -0.03 & 0.04 & 1.00\\
adults diff & Intercept & 0.64 & 0.02 & 0.59 & 0.68 & 1.00\\
 & Condition & -0.21 & 0.04 & -0.29 & -0.13 & 1.00\\
 & Difference Mouse-Bear & -0.04 & 0.01 & -0.05 & -0.02 & 1.00\\
 & Condition:Difference Mouse-Bear & 0.01 & 0.02 & -0.02 & 0.04 & 1.00\\
\bottomrule
\end{longtable}
...
For toddlers, we found a significant effect of condition, with higher proportion DLS in the ignorance condition compared to the knowledge condition. The effect of location and the interaction between condition and location were not significant (see Table S5). A model comparison testing the inclusion of the location effect yielded a Bayes factor of BF = 0.9, indicating anecdotal evidence against its contribution. A Bayes factor comparison indicated anecdotal evidence against the interaction model, with
BF = 0.6.
...
{\centering \includegraphics[width=6.8in]{/Users/mellischreiner/Documents/GitHub/mb2-analysis/paper/FigureS6} 
