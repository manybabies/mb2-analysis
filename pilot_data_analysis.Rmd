...
## Logistic Mixed-level analysis during the pre-disambiguation period (-620 to 120 window)

### compare pilot 1a (trial 1 to 4) and pilot 1b outcome
```{r mixed-level logistic analysis}
d_620_window_1a_1b_outcome <- d %>% 
  filter(t >= -620, t <= 120, 
...
ls_target_620_1a_1b_outcome <- glmer(aoi_dummy ~ trial_num + experiment_num + (trial_num|subid), 
                                     data = d_620_window_1a_1b_outcome, family = "binomial")
summary(ls_target_620_1a_1b_outcome)
```

### only focus on pilot 1b non outcome
```{r}
d_620_window_1b_no_outcome <- d %>% 
  filter(t >= -620, t <= 120, 
...
ls_target_620_1b_no_outcome <- glmer(aoi_dummy ~ trial_num + (trial_num|subid), 
                                     data = d_620_window_1b_no_outcome, family = "binomial")
summary(ls_target_620_1b_no_outcome)
```

## Logistic Mixed-level analysis during the poste-disambiguation period (0 to 620), compare pilot 1b outcome vs no-outcome
```{r}
d_620_window_1b <- d %>% 
  filter(t >= 0, t <= 620, 
...
ls_target_620_1b <- glmer(aoi_dummy ~ trial_num + experiment_num + (trial_num|subid), 
                                     data = d_620_window_1b, family = "binomial")
summary(ls_target_620_1b)
```
