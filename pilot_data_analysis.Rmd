...
# 
# first_look_logistic <- glmer(correct_first_anticipation ~ trial_num + (1|subid) + (1|lab), data = anticipations, family = "binomial")
# 
...
## first, data visualization across different test trials
```{r}
